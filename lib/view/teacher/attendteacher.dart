...
class attendteacher extends StatefulWidget {
  @override
  State<attendteacher> createState() => _attendteacherState();
}

class _attendteacherState extends State<attendteacher> {
  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    Provider.of<TeacherAttendetVN>(context, listen: false)
        .getdata(OnlineRepo(), API_URL.TEACHER_ATTENDETN, Shared.id!);
  }
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              SizedBox(height: 20),
                              Text(
                                getDayOfWeek(DateFormat("yyyy-MM-dd").parse(
                                    "${element.teacherAttendanceDate}"
                                        .split("T")
                                        .first)),
