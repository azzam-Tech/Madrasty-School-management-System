...
import 'package:graduation_project/view/teacher/components/drawer/bottom_user_info.dart';
import 'package:graduation_project/constant/drawer/header.dart';

import 'package:graduation_project/view/teacher/tabbar/classtab/desctutionT/tdescution.dart';
import 'package:graduation_project/view/teacher/tabbar/classtab/diaryclass/diaryclass.dart';
import 'package:graduation_project/view/teacher/tabbar/classtab/grads/grads.dart';
import 'package:graduation_project/view/teacher/tabbar/classtab/homeworknotification/Homework_tab.dart';
import 'package:graduation_project/view/teacher/tabbar/classtab/questionfromstudents/question.dart';
...
class CustomDrawer extends StatefulWidget {
  CustomDrawer({Key? key, required this.instanc}) : super(key: key);
                  ...
                  CustomListTile(
                    ...
                    onPressed: () async {
                      ...
                      Navigator.of(context).push(PageTransition(
                        ...
                        duration: Duration(milliseconds: 600),
                        reverseDuration: Duration(microseconds: 600),
                        child: ReportPage(instanc: widget.instanc,),
                      ));
                    },
                  ...
                  CustomListTile(
                    ...
                    onPressed: () async {
                      ...
                      Navigator.of(context).push(PageTransition(
                        ...
                        duration: Duration(milliseconds: 600),
                        reverseDuration: Duration(microseconds: 600),
                        child: StudentMarksPage(instanc: widget.instanc,),
                      ));
                    },
                  ...
                  CustomListTile(
                    ...
                    onPressed: () async {
                      ...
                      Navigator.of(context).push(PageTransition(
                        ...
                        duration: Duration(milliseconds: 600),
                        reverseDuration: Duration(microseconds: 600),
                        child: NotificationPage(instanc: widget.instanc),
                      ));
                    },
                  ...
                  CustomListTile(
                    ...
                    onPressed: () async {
                      ...
                      Navigator.of(context).push(PageTransition(
                        ...
                        duration: Duration(milliseconds: 600),
                        reverseDuration: Duration(microseconds: 600),
                        child: diary(instanc:widget.instanc ,),
                      ));
                    },
                  ...
                  CustomListTile(
                    ...
                    onPressed: () async {
                      ...
                      Navigator.of(context).push(PageTransition(
                        ...
                        duration: Duration(milliseconds: 600),
                        reverseDuration: Duration(microseconds: 600),
                        child: ViewQuestion(instanc: widget.instanc,),
                      ));
                    },
